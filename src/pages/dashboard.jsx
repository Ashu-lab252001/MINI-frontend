    ...
    <div className="dashboard-container">
      ...
      <div className="sidebar">
        ...
        <ul className="sidebar-menu">
          <li>
            <button className="sidebar-link-button" onClick={() => navigate("/dashboard")}> <img className="image1" src={Image4} alt="Dashboard" />Dashboard</button>
            <button className="sidebar-link-button" onClick={() => navigate("/links")}>  <img className="image1" src={Image1} alt="Links" />Links</button>
            <button className="sidebar-link-button" onClick={() => navigate("/analytics")}> <img className="image1" src={Image2} alt="Analytics" />Analytics</button>
            <hr />
            <button className="sidebar-link-button" onClick={() => navigate("/settings")}><img className="image1" src={Image3} alt="Settings" />Settings</button>
          </li>
        </ul>
      </div>
